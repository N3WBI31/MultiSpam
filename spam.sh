...
echo
echo
echo $daun "Tools By Mr.BksMilenial"
sleep 1
...
sleep 1
echo $daun "Code By MR.BksMilenial"
sleep 1
...
if [ $pilih = "E" ] || [ $pilih = "e" ]
then
echo $merah "Author = ./Zarel.IT"
sleep 1
echo $daun "Whatsapp = 08821098xxxx"
sleep 1
